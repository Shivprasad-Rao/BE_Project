...
//connectDB();
mongoose.connect("mongodb+srv://ShivaRao:T4ITnbLgjDQTgCxQ@cluster0.syx5jly.mongodb.net/test?retryWrites=true&w=majority")
    .then(()=>{
        app.listen(5000);
    })
    .catch((err)=>{
...
//mongodb+srv://ShivaRao:bRm5azx3kixnpzeR@cluster0.syx5jly.mongodb.net/test
